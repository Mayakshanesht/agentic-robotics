...
export default function Contact() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Failed to send. Please email mayur.waghchoure@cloudbeerobotics.de directly.");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="glass-card p-6">
                ...
                <div className="space-y-4 text-sm">
                  <a href="mailto:mayur.waghchoure@cloudbeerobotics.de" className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
