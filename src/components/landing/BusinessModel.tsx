...
/** The three pricing steps and CTAs — the model only. Rates are shared on request, never on the site. */
...
/** How customers pay, as a page section (used on the product page). */
